...
class Vermont(BaseOVRForm):
    ...
    def __init__(self):
        super(Vermont, self).__init__('https://olvr.sec.state.vt.us/Registration/RegistrationDetails')
        self.add_required_fields(['will_be_18', 'legal_resident', 'state_id_number'])
