...
from form_utils import (ValidationError, options_dict, clean_browser_response,
                        split_date, split_name, parse_gender)
...
class Illinois(BaseOVRForm):
    ...
    def __init__(self):
        ...
        self.success_string = 'Your application is now being processed by your local election authority'
