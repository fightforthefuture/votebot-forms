...
class Alaska(BaseOVRForm):

    def __init__(self):
        super(Alaska, self).__init__('https://voterregistration.alaska.gov/Registration/RegistrationDetails?haveValidAKDL=true')
        self.add_required_fields(['will_be_18', 'legal_resident', 'state_id_number', 'ssn_last4'])
